        ...
        <Container fluid className='bg-white' role='section' aria-label='dr claire lee about section'>
            ...
            <Row role="row" aria-label="dr claire lee info">
                ...
                <Col md={9}>
                    ...
                    <p className='text-start fs-5'>Her research interests range from cybercrime and cybersecurity education to global media and im/migration.</p>
                    ...
                    <address className="text-start fs-5">
                        ...
                        Associate Professor, School of Criminology and Justice Studies <br/>
